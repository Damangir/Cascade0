 ...
 */
#ifndef __itkPercentileFilterPipeline_hxx
#define __itkPercentileFilterPipeline_hxx
#include "itkPercentileFilterPipeline.h"

namespace itk
{
template< class TInputImage, class TOutputImage, class TMaskImage >
PercentileFilterPipeline< TInputImage, TOutputImage, TMaskImage >::PercentileFilterPipeline()
  {
...
template< class TInputImage, class TOutputImage, class TMaskImage >
void PercentileFilterPipeline< TInputImage, TOutputImage, TMaskImage >::PrintSelf(
...
template< class TInputImage, class TOutputImage, class TMaskImage >
void PercentileFilterPipeline< TInputImage, TOutputImage, TMaskImage >::GenerateData()
  {
  ...
  for (int i = 1; i <= 100; i+=1)
    ...
    lookupFunctor.AddLookupRow(levelIntensity, i);
    }
