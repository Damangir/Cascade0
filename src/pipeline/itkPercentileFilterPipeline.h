 ...
 */
#ifndef __itkPercentileFilterPipeline_h
#define __itkPercentileFilterPipeline_h
...
class ITK_EXPORT PercentileFilterPipeline:
  public ImageToImageFilter< TInputImage, TOutputImage >
{
public:
  /** Standard "Self" & Superclass typedef.   */
  typedef PercentileFilterPipeline                            Self;
  ...
  itkTypeMacro(PercentileFilterPipeline, ImageToImageFilter);
...
protected:
  PercentileFilterPipeline();

  virtual ~PercentileFilterPipeline()  {}

  void GenerateData();

  void PrintSelf(std::ostream &, Indent) const;
private:
  PercentileFilterPipeline(const Self &); //purposely not implemented
...
#include "itkPercentileFilterPipeline.hxx"
#endif
