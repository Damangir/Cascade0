 ...
 */
#ifndef __itkN4Pipeline_hxx
#define __itkN4Pipeline_hxx
#include "itkN4Pipeline.h"
...
N4Pipeline< TInputImage, TOutputImage >::N4Pipeline()
  {
  m_MinSampleDistance = 5;
  }

template< class TInputImage, class TOutputImage >
void N4Pipeline< TInputImage, TOutputImage >::PrintSelf(std::ostream & os,
                                                        Indent indent) const
  {
...
template< class TInputImage, class TOutputImage >
void N4Pipeline< TInputImage, TOutputImage >::GenerateData()
  {
